...
{
public:
    ClientCore(boost::asio::io_service& io_service, tcp::resolver::iterator endpoint_iterator)
        : io_service_(io_service), socket_(io_service), initialized_(false), client_counts_(0)
    {
        tcp::endpoint endpoint = *endpoint_iterator;
        socket_.async_connect(endpoint,
            boost::bind(&ClientCore::handle_connect, this,
    ...
    void close()
    {
        io_service_.post(boost::bind(&ClientCore::do_close, this));
    }
...
private:
    ...
    void do_write(const std::vector<double>& pos)
    {
        ...
        boost::asio::async_write(socket_,
            boost::asio::buffer(head, header_size),
            boost::bind(
            &ClientCore::handle_write_header,
            this,
            pos,
            boost::asio::placeholders::error
            )
