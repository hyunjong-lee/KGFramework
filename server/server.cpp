...
int main(int argc, char* argv[])
{
  while(true)
  {
    ...
    // insert logical processes of Server side of KnotGame Project
    boost::posix_time::ptime local_time = boost::posix_time::microsec_clock::local_time();
...
#if !defined(_MT)
#error _beginthreadex requires a multithreaded library.
#endif
